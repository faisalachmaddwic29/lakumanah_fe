...
class ApiLakumanah implements ApiService {
   ...
   */
  private async makeRequest<TResponse, TBody = unknown, TParams = unknown>(
...
const apiLakumanah = new ApiLakumanah();
export default apiLakumanah;
