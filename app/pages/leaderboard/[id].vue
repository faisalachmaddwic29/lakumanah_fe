    ...
    <div class="flex flex-col gap-y-5 w-full px-4">
        ...
        <div class="flex gap-1 justify-between items-start">
          <div class="flex flex-col gap-1 text-white font-lato">
            ...
            <div class="flex gap-1.5 items-center text">
              <NuxtImg
                src="/icons/user-group-white.svg"
                alt="user-group"
                class="size-5"
              />
          ...
          <div>
            <Icon
              ...
              :class="isLoading ? ' animate-spin' : 'cursor-pointer'"
              @click="isLoading ? null : handleRefresh"
            />
          </div>
        </div>
      </div>
      ...
      <div v-if="leaderboards.length" class="w-full mx-auto">
        ...
        <div
          ...
          class="text-center text-sm py-3 text-gray-400"
        >
      ...
      <!-- Empty state -->
      <div
        v-else-if="!isFirstLoading && leaderboards.length === 0"
      ...
      <div v-if="isFirstLoading" class="divide-y divide-gray-200">
        <div
          v-for="n in 3"
          :key="n"
          class="grid grid-cols-[2fr_1.2fr_auto] items-center py-3 animate-pulse"
        >
          <div class="flex items-center gap-[10px]">
