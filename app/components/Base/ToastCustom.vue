...
<template>
  <div
    class="relative flex items-center m-0 p-5 mb-4 pb-6 text-gray-500 bg-white rounded-lg shadow-sm border"
    role="alert"
  >
    <!-- Icon -->
    <div
    ...
    <button
      type="button"
      class="absolute right-1 top-1 bg-white text-gray-400 hover:text-gray-900 rounded-full focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-6 w-6 cursor-pointer"
      aria-label="Close"
      @click="handleClick"
    >
