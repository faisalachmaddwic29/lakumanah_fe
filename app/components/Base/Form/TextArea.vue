  ...
  <div class="relative flex flex-col">
    ...
    <div class="relative">
      ...
      <div
        v-if="isIcon"
        :class="[
          'absolute top-2.5 text-xl text-subtle',
...
const props = defineProps({
  ...
  isNumber: { type: Boolean, default: false }, // optional
});

const emit = defineEmits(["update:modelValue", "blur"]);

const baseClasses =
  "w-full font-manrope text-sm md:text-base ring-none placeholder-[#C5C5C5] dark:placeholder-[rgba(197,197,197,0.2)] border border-[#C5C5C5] dark:border-[rgba(197,197,197,0.2)] transition duration-300 ease-in-out rounded-lg outline-none focus:border-[var(--primary)] dark:focus:border-[var(--primary)] px-4 py-3 resize-none";
