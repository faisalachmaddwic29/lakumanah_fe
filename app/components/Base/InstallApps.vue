<template>
  <div>
    ...
    <ItemsListButton
      v-if="!isIOS && canInstall && !isInstalled"
      type="default"
      title="Instal Lakumanah"
      subtitle="Lebih mudah akses Lakumanah di smartphone kamu."
    >
      <template #icon>
        <NuxtImg
          src="/images/logos/logo-square.png"
          class="w-10 h-10 aspect-square rounded-lg"
          alt="Lakumanah Logo"
        />
      </template>
      <template #actions>
    ...
    <!-- Panduan untuk iOS -->
    <ItemsListButton
      v-if="isIOS && !isInstalled"
      type="default"
      title="Instal Lakumanah"
      subtitle="Tap tombol Share di bawah, lalu pilih 'Add to Home Screen'."
    >
      <template #icon>
        <NuxtImg
          src="/images/logos/logo-square.png"
      ...
      >
        ...
        <div class="space-y-3 text-sm">
          <div class="flex items-start gap-3">
            ...
            <p>Tap tombol <strong>Share</strong> (ikon dengan panah keluar) di Safari</p>
          </div>
          <div class="flex items-start gap-3">
            ...
            <p>Scroll ke bawah dan pilih <strong>"Add to Home Screen"</strong></p>
          </div>
          <div class="flex items-start gap-3">
            ...
            <p>Tap <strong>"Add"</strong> untuk menambahkan ke home screen</p>
          </div>
        </div>
        <button
          class="w-full mt-6 bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition"
          @click="showIOSModal = false"
        >
          Mengerti
        </button>
